...
var ProcessSchemaPropertySchema = /*#__PURE__*/z.union([/*#__PURE__*/z.custom(), /*#__PURE__*/z["null"]()]);
...
var ContentFragmentSchema = /*#__PURE__*/z.object({
  ...
  contentNodeData: /*#__PURE__*/ContentFragmentNodeData.nullable()
});
...
var ValidateActionRequestBodySchema = /*#__PURE__*/z.object({
  actionId: /*#__PURE__*/z.number(),
  approved: /*#__PURE__*/z["enum"](["approved", "rejected", "always_approved"])
});
...
var TOOL_MIME_TYPES = {
  TOOL_INPUT: /*#__PURE__*/generateToolMimeTypes({
    category: "TOOL_INPUT",
    resourceTypes: ["DATA_SOURCE", "TABLE", "CHILD_AGENT", "STRING", "NUMBER", "BOOLEAN", "ENUM", "REASONING_MODEL", "NULLABLE_TIME_FRAME"]
  }),
  TOOL_OUTPUT: /*#__PURE__*/generateToolMimeTypes({
    category: "TOOL_OUTPUT",
    resourceTypes: ["BROWSE_RESULT", "DATA_SOURCE_SEARCH_QUERY", "DATA_SOURCE_SEARCH_RESULT", "DATA_SOURCE_INCLUDE_QUERY", "DATA_SOURCE_INCLUDE_RESULT",
    ...
    "THINKING", "WEBSEARCH_QUERY", "WEBSEARCH_RESULT"]
  })
};
...
var DustAPI = /*#__PURE__*/function () {
  ...
  ;
  _proto.validateAction =
  /*#__PURE__*/
  function () {
    var _validateAction = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee39(_ref22) {
      var conversationId, messageId, actionId, approved, res;
      return _regeneratorRuntime().wrap(function _callee39$(_context39) {
        while (1) switch (_context39.prev = _context39.next) {
          case 0:
            conversationId = _ref22.conversationId, messageId = _ref22.messageId, actionId = _ref22.actionId, approved = _ref22.approved;
            _context39.next = 3;
            return this.request({
              method: "POST",
          ...
          case 3:
            res = _context39.sent;
            return _context39.abrupt("return", this._resultFromResponse(ValidateActionResponseSchema, res));
          case 5:
          case "end":
    ...
    function validateAction(_x42) {
      return _validateAction.apply(this, arguments);
    }
    return validateAction;
  }();
  _proto.registerMCPServer = /*#__PURE__*/function () {
    var _registerMCPServer = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee40(_ref23) {
      var serverId, res;
      return _regeneratorRuntime().wrap(function _callee40$(_context40) {
        while (1) switch (_context40.prev = _context40.next) {
          case 0:
            serverId = _ref23.serverId;
            _context40.next = 3;
            return this.request({
              method: "POST",
              path: "mcp/register",
          ...
          case 3:
            res = _context40.sent;
            return _context40.abrupt("return", this._resultFromResponse(RegisterMCPResponseSchema, res));
          case 5:
          case "end":
    ...
    function registerMCPServer(_x43) {
      return _registerMCPServer.apply(this, arguments);
    }
    return registerMCPServer;
  }();
  _proto.heartbeatMCPServer = /*#__PURE__*/function () {
    var _heartbeatMCPServer = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee41(_ref24) {
      var serverId, res;
      return _regeneratorRuntime().wrap(function _callee41$(_context41) {
        while (1) switch (_context41.prev = _context41.next) {
          case 0:
            serverId = _ref24.serverId;
            _context41.next = 3;
            return this.request({
              method: "POST",
              path: "mcp/heartbeat",
          ...
          case 3:
            res = _context41.sent;
            return _context41.abrupt("return", this._resultFromResponse(HeartbeatMCPResponseSchema, res));
          case 5:
          case "end":
    ...
    function heartbeatMCPServer(_x44) {
      return _heartbeatMCPServer.apply(this, arguments);
    }
    return heartbeatMCPServer;
  }();
  _proto.postMCPResults = /*#__PURE__*/function () {
    var _postMCPResults = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee42(_ref25) {
      var requestId, result, serverId, params, res;
      return _regeneratorRuntime().wrap(function _callee42$(_context42) {
        while (1) switch (_context42.prev = _context42.next) {
          case 0:
            requestId = _ref25.requestId, result = _ref25.result, serverId = _ref25.serverId;
          ...
          case 5:
            res = _context42.sent;
            return _context42.abrupt("return", this._resultFromResponse(PostMCPResultsResponseSchema, res));
          case 7:
          case "end":
    ...
    function postMCPResults(_x45) {
      return _postMCPResults.apply(this, arguments);
    }
    return postMCPResults;
  }();
  _proto.getMCPRequestsConnectionDetails = /*#__PURE__*/function () {
    var _getMCPRequestsConnectionDetails = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee43(_ref26) {
      var serverId, lastEventId, url, params, headers;
      return _regeneratorRuntime().wrap(function _callee43$(_context43) {
        while (1) switch (_context43.prev = _context43.next) {
          case 0:
            serverId = _ref26.serverId, lastEventId = _ref26.lastEventId;
    ...
    function getMCPRequestsConnectionDetails(_x46) {
  ...
  _proto._resultFromResponse = /*#__PURE__*/function () {
    var _resultFromResponse2 = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee44(schema, res) {
      ...
      return _regeneratorRuntime().wrap(function _callee44$(_context44) {
        while (1) switch (_context44.prev = _context44.next) {
          ...
          case 2:
            ...
            return _context44.abrupt("return", new Err(err));
          case 6:
            _context44.next = 8;
            return textFromResponse(res.value.response);
          case 8:
            ...
            return _context44.abrupt("return", new Ok(r.data));
          case 16:
            ...
            return _context44.abrupt("return", new Err(rErr.data));
          case 22:
            ...
            return _context44.abrupt("return", new Err(_err));
          case 25:
            _context44.next = 32;
            break;
          case 27:
            ...
            _err2 = {
              type: "unexpected_response_format",
              message: "Fail to parse response from DustAPI calling " + (res.value.response.url + " : " + _context44.t0)
            };
            this._logger.error({
              dustError: _err2,
              error: _context44.t0,
            ...
            return _context44.abrupt("return", new Err(_err2));
          case 32:
          case "end":
    ...
    function _resultFromResponse(_x47, _x48) {
